...
public interface AwardCertificateDAO {
    ...
    String INSERT_FIELDS = "user_id, name, is_valid, category, explanation, comment, img_path";
    ...
    @Insert({"insert into ", TABLE_NAME, "(", INSERT_FIELDS, ") values(#{userId}, #{name}, #{isValid}, #{category}, #{explanation}, #{comment}, #{imgPath})"})
